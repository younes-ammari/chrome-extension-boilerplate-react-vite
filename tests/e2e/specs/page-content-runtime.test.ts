describe('Webextension Content Runtime Script', () => {
  ...
  it('should create runtime element on the page', async () => {
    ...
    // Check if id copyable-extension-runtime-content-view-root exists on page
    const runtimeElement = await $('#copyable-extension-runtime-content-view-root').getElement();
